...
<script>
    $(document).ready(function() {
        ...
        function calculateTotals() {
            ...
            let adjustment = parseFloat($('#currentOutstanding').val()) || 0;
...
@section('title', 'Preview/Edit Individual Settlement')
@section('content')
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">
                        <i class="fas fa-user-edit me-2"></i> Preview/Edit Individual Settlement
                    </h5>
                    <div>
                    ...
                    <div class="organization-card show">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('current_outstanding', $bill->balance ?? 0) }}"
                                        required readonly>
                                </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <small class="text-muted-small">(Current Outstanding + Total Diet Charges Due) - Security Deposit</small>
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('notes') is-invalid @enderror"
                                    ...
                                    name="remarks"
                                    rows="3"
                                    placeholder="Enter any additional notes or remarks">{{ old('notes', $bill->remarks ?? '') }}</textarea>
                                @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
