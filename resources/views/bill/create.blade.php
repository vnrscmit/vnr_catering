...
<script>
    $(document).ready(function() {
        ...
        function calculateBill() {
            ...
            // Net Monthly Expense
            let netExpense = totalExpense - (guestExpense + individualExpense);
            ...
            if (netChargeableDiet > 0) {
                perDiet = Math.ceil(netExpense / netChargeableDiet);
            }
        ...
        <div class="card">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('bill-generate.store') }}" method="POST">
