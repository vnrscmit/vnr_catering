    ...
    public function rules(): array
    {
        ...
        return [
            'organization_name' => [
                ...
                'string',
                'max:255',
                Rule::unique('organizations', 'organization_name')->ignore($organizationId),
            ],
            'short_name' => [
                'required',
                'string',
                'max:50',
                Rule::unique('organizations', 'short_name')->ignore($organizationId),
            ],
            ...
            'gstin' => [
                ...
                'string',
                'max:15',
                Rule::unique('organizations', 'gstin')->ignore($organizationId),
            ],
        ];
    }
